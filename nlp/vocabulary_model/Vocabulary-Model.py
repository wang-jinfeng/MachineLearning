...
"""
    Time    : 2018/7/20 下午5:46
    Author  : wangjf
    File    : Vocabulary-Model.py
    GitHub  : https://github.com/wjf0627

    词汇表模型：
        词袋模型可以很好的表现文本由哪些单词组成，但是却无法表达出单词之间的前后关系
...
"""
max_document_length:
    文档的最大长度。如果文本的长度大于最大程度，那么它会被剪切，反之则用 0 填充
min_frequency:
    词频的最小值，出现次数小于最小词频则不会被收录到词表中
vocabulary:
    CategoricalVocabulary 对象
tokenizer_fn:
    分词函数
"""
#   创建词汇表，创建后不能更改
